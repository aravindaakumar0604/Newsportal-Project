...
?>
			...
			<a href="view_individual_page.php?title=<?php echo $row['title'];?>" value="<?php echo $row['title'];?>" name="<?php echo $row['title'];?>"><h3 style="font-family: Helvetica;color: darkblue;float:left;"><?php echo $row['title'];?></h3></a><br/><br/>&nbsp;&nbsp;
				<center>
				<h6><?php echo $row['day'];?><br/>
