...
?>
			<a href="view_individual_page.php?title=<?php echo $row['title'];?>" value="<?php echo $row['title'];?>" name="<?php echo $row['title'];?>">
			<font class="breaking">breaking news :<?php echo $row['title'];?></font>&nbsp;&nbsp;</a>
<?php 
	}
?>
...
<?php 
	...
	$result = mysqli_query($conn,"select * from news where title='$title'");
	while($row = mysqli_fetch_assoc($result)){
?>
			<div class="posts" align="center">
			<h3 style="font-family: Helvetica;color: darkblue;float:left;"><?php echo $row['title'];?></h3><br/><br/>&nbsp;&nbsp;
